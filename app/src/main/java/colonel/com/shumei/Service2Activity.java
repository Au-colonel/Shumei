...
public class Service2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                serviceDialog = new ServiceDialog(Service2Activity.this);
                serviceDialog.setTitle("已为您自动匹配距您最近的拖车公司,预计费用为");
                serviceDialog.setMessage("200.00元");
                serviceDialog.setYesOnclickListener("确认继续", new ServiceDialog.onYesOnclickListener() {
                    ...
                    public void onYesClick() {
                        ...
                        now_content.setVisibility(View.GONE);
                        now_content_p.setVisibility(View.VISIBLE);
                        toast = Toast.makeText(Service2Activity.this,"救援受理中...",Toast.LENGTH_SHORT);
                        toast.show();
